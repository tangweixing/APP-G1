...
struct LivoxData
{
    ...
    std::deque<fastlio::PointCloudXYZI::Ptr> buffer_filter;
    std::deque<double> time_buffer;
    double blind = 0.5;
    int filter_num = 3;
    double last_timestamp = 0;
    void callback(const livox_ros_driver2::CustomMsg::ConstPtr &msg);
    void livox2pcl(const livox_ros_driver2::CustomMsg::ConstPtr &msg, fastlio::PointCloudXYZI::Ptr &out_filter, fastlio::PointCloudXYZI::Ptr &out);
...
struct MeasureGroup
{
    ...
    fastlio::PointCloudXYZI::Ptr lidar_org;
