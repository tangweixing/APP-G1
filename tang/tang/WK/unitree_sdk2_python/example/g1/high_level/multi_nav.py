...
if __name__ == '__main__':
    try:
        ...
        waypoints = [
            {"x": -8.13, "y": -1.6, "yaw": 3.5733, "action_id": 2, "say_text": "领导们好，我是朝野"},
            {"x": -6.831, "y":-0.688, "yaw": 1.5733, "action_id": 10, "say_text": "这是朝野的产品"},
            # {"x": -4.23, "y": -0.977, "yaw": 2.0758, "action_id": 10, "say_text": "这是朝野的显示器"},
            {"x": -0.88, "y": -0.255, "yaw": 0.00738, "action_id": 8, "say_text": "请给我充电"},
        ]
