...
def navigate_to_waypoints(waypoints, robot_controller):
    ...
    rospy.set_param('/move_base/planner_patience', 30.0)   # 增加到30秒
    rospy.set_param('/move_base/planner_frequency', 2.0)   # 提高规划频率
...
if __name__ == '__main__':
    try:
        ...
        waypoints = [
        #    {"x": -10.9, "y": -0.27, "yaw": 3.5733, "action_id": 2, "say_text": "您们好，我是朝野小助理。"},
        #    {"x": -10.9, "y": -1.64, "yaw": -1.0533, "action_id": 1, "say_text": "我带你们参观朝野科技会议室，请往这边走。"},
        #     {"x": -4.33, "y": -13.465, "yaw": 0.87138, "action_id": 10, "say_text": "这是朝野科技的软件组，负责处理所有软件相关的项目，需要定制智能体、软件就找他们。"},
            {"x": -18.9, "y": 2.41, "yaw": 2.2758, "action_id": 2, "say_text": "再见需要合作就找我们！"},
               {"x": -1.77, "y": -0.305, "yaw": 3.14138, "action_id": 10, "say_text":"工程师请控制我跳舞！跳完记得帮我充电！"},
        ]
